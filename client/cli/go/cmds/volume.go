...
func init() {
	...
	volumeCreateCommand.Flags().StringVar(&volumeOptions, "options", "",
...
var volumeCreateCommand = &cobra.Command{
  ...
  * Create a 100GB distributed volume which supports encryption
...
`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if volumeOptions != "" {
			req.Options = strings.Split(volumeOptions, ",")
		}
